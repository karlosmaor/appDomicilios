...
api.get('/delivery/search/domiciliarios/:client', DeliveryCtrl.GetDomiciliariosDeliveries)
api.post('/delivery/start', DeliveryCtrl.StartDelivery)
api.post('/delivery/finish', DeliveryCtrl.DeliveryFinished)
...
api.get('/maps/all/domiciliarios', MapCtrl.showAllDomiciliarios)
